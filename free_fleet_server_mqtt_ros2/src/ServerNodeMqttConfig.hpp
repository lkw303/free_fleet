...
#ifndef FREE_FLEET_SERVER_ROS2__SRC__SERVERNODEMQTTCONFIG_HPP
#define FREE_FLEET_SERVER_ROS2__SRC__SERVERNODEMQTTCONFIG_HPP
...
struct ServerNodeMqttConfig
{
  ...
  ServerMqttConfig get_server_config() const;

  static ServerNodeMqttConfig make();
